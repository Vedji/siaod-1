...
void showData(Tours arr[SIZE_OF_TRIP], int size_init_array) {
...
void Sorting_array_by_countries(Tours arr[SIZE_OF_TRIP], int size_init_array) {
...
void Deleting_finished_tours(Tours arr[SIZE_OF_TRIP], int size_init_array, string date) {
    for (int i = 0; i < size_init_array - 1; i++) {
